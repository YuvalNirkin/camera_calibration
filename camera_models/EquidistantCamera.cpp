...
void EquidistantCamera::Parameters::writeToCfgFile(const std::string& filename) const
{
    // Open file stream
    ...
    file << "KANNALA_BRANDT" << std::endl;

    // Write data to file
    file << m_mu << " " << m_mv << " " << m_u0 << " " << m_v0 << " "
        << m_k2 << " " << m_k3 << " " << m_k4 << " " << m_k5 << " " << std::endl;
...
// Yuval
void EquidistantCamera::writeParametersToCfgFile(const std::string& filename) const
{
