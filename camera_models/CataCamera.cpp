...
void CataCamera::Parameters::writeToCfgFile(const std::string& filename) const
{
    // Open file stream
    ...
    // Write data to file
    file << m_gamma1 << " " << m_gamma2 << " " << m_u0 << " " << m_v0 << " "
...
// Yuval
void CataCamera::writeParametersToCfgFile(const std::string& filename) const
{
